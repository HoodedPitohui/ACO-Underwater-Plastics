...
%% Set File Names
fireDatasheet = '../data/trashData.xlsx';
sheetName = 'sheet0';
trialName = 'trial1';
regionName = 'Region1';
    ...
    while t <= environment.maxIter && drones.bestSolutionsFound(d) ~= 1
        ...
        for k = 1: 1: drones.antNo
            if (t == 1 && k == 1 ||(drones.colony(d).ant(k).distFitness > 0 && ...
                    drones.colony(d).ant(k).distFitness < drones.bestFireDist(1, d)...
                    && drones.colony(d).ant(k).fireFitness < ...
                    5 + drones.bestFireFitness(1, d)))
